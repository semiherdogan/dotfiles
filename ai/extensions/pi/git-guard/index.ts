...
const ALLOWED_SUBCOMMANDS = new Set(["status", "log", "diff", "show", "ls-files"]);
...
const BLOCK_REASON = [
	"Git operations are forbidden for the agent in this project. Only `git status`, `git log`, `git diff`, `git show` and `git ls-files` are allowed.",
